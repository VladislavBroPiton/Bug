...
Шаги: **1**. Ввести валидную почту. **2**. Ввести валидный пароль. **3**. Войти. **4**. Нажать кнопку "Настройки". **5**. Выбрать пункт меню "Личный кабинет".  **6**. Открыть вкладку "Мой адресс"
